...
export function NewAbout() {
  ...
  const values = [
    ...
    },
    {
      ...
      description: "Rigorous testing and quality checks ensure we deliver nothing but excellence.",
  ...
  const timeline = [
    {
      year: "2010",
      title: "Foundation",
      description: "SAPIVI was founded with a vision to transform businesses through technology."
    },
    {
      year: "2015",
      title: "Expansion",
      description: "Expanded services to include digital marketing and cybersecurity solutions."
    },
    {
      year: "2020",
      title: "Innovation",
      description: "Launched AI-powered HR consulting and advanced analytics services."
    },
    {
      year: "2024",
      title: "Excellence",
      description: "Recognized as industry leader with 500+ successful projects delivered."
    }
  ];
  ...
  const team = [
    ...
    {
      role: "Developers",
      description: "Expert engineers proficient in latest technologies and frameworks.",
      icon: Zap,
    ...
    {
      role: "Consultants",
      description: "Strategic advisors guiding businesses through digital transformation.",
      icon: Users,
    ...
    <div className="min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div>
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 tracking-tight">
              Crafting Digital<br />
              <span className="text-primary">Excellence</span> Since 2010
            </h1>
            
            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-12 leading-relaxed">
              We're a team of innovators, designers, and developers passionate about 
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="glass-dark p-6 rounded-2xl hover:bg-white/10 transition-all group"
                >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div
              ...
              className="p-12 bg-gradient-to-br from-primary to-cyan-600 text-white rounded-3xl"
            >
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                ...
                efficiency, and competitive advantage in the digital era. We strive to be the trusted 
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="p-12 bg-gradient-to-br from-secondary to-secondary/90 text-white rounded-3xl"
            >
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                ...
                expertise, and unwavering commitment to client success. We envision a future where 
                technology seamlessly enhances every business operation.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-32 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-secondary mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className={`group p-10 bg-gradient-to-br ${value.gradient} rounded-3xl cursor-pointer`}
              >
          ...
          <div className="space-y-12">
            {timeline.map((item, index) => (
              ...
              >
                ...
                <div className="flex-shrink-0 w-4 h-4 bg-primary rounded-full ring-4 ring-primary/20" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                whileHover={{ y: -10 }}
                className="glass-dark p-8 rounded-3xl text-center group cursor-pointer"
              >
      ...
      <section className="py-32 bg-white relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold text-secondary mb-4">
              Why Choose <span className="gradient-text">SAPIVI</span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="flex items-center space-x-4 p-6 bg-muted rounded-2xl hover:bg-primary/10 transition-all group"
              >
                ...
                <span className="text-lg font-medium text-secondary">{item}</span>
              </motion.div>
            ))}
          </div>
        </div>
