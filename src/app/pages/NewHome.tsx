        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center space-x-2 px-4 py-2 glass-dark rounded-full mb-8"
            >
            ...
            >
              We transform businesses with cutting-edge digital solutions, 
              AI-powered HR consulting, and enterprise-grade technology.
            </motion.p>
            ...
            >
              <Link
                to="/contact"
                className="group px-8 py-4 bg-accent text-white rounded-full font-semibold hover:bg-accent/90 hover:shadow-2xl hover:shadow-accent/50 hover:scale-105 transition-all flex items-center space-x-2"
              >
              ...
              <Link
                to="/portfolio"
                className="px-8 py-4 glass-dark text-white rounded-full font-semibold hover:bg-white/20 transition-all"
              >
                View Our Work
              </Link>
            </motion.div>
      ...
      <section className="py-32 bg-white relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {services.map((service, index) => (
              <motion.div
                ...
                className={`group relative p-8 md:p-12 bg-gradient-to-br ${service.gradient} rounded-3xl overflow-hidden cursor-pointer ${
          ...
          >
            <Link
              to="/services"
              className="inline-flex items-center px-8 py-4 bg-secondary text-white rounded-full font-semibold hover:bg-secondary/90 hover:shadow-xl hover:scale-105 transition-all"
            >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-4">
              Why Choose <span className="text-primary">SAPIVI</span>?
            </h2>
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Experience, innovation, and dedication combined
            </p>
          </motion.div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
              Join 500+ businesses that trust SAPIVI for their digital transformation journey.
            </p>
            <Link
              to="/contact"
              className="inline-flex items-center px-10 py-5 bg-accent text-white rounded-full font-bold text-lg hover:bg-accent/90 hover:shadow-2xl hover:shadow-accent/50 hover:scale-105 transition-all"
            >
              Let's Talk
