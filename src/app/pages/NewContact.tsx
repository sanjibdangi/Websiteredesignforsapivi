  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email Us",
      value: "contact@sapivi.com",
      link: "mailto:contact@sapivi.com",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                className={`group relative p-8 bg-gradient-to-br ${info.gradient} rounded-3xl overflow-hidden cursor-pointer`}
              >
                ...
                <div className="relative z-10">
                  ...
                  {info.link ? (
                    <a href={info.link} className="text-white font-bold text-lg hover:underline">
                      {info.value}
                    </a>
                  ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 bg-muted border-2 border-transparent rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-6 py-4 bg-muted border-2 border-transparent rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none"
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full px-8 py-5 bg-accent text-white rounded-2xl font-bold text-lg hover:bg-accent/90 hover:shadow-xl hover:shadow-accent/30 transition-all flex items-center justify-center space-x-2 group"
                >
            ...
            >
              ...
              <div className="p-8 bg-gradient-to-br from-primary to-cyan-600 text-white rounded-3xl">
                ...
                <h3 className="text-2xl font-bold mb-3">Prefer to Chat?</h3>
                <p className="text-white/90 mb-6">
                  Our team is available for a quick call or video meeting.
                </p>
