...
export function NewPortfolio() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Work That <span className="text-primary">Inspires</span>
            </h1>
      ...
      {/* Filter Section */}
      <section className="sticky top-20 z-40 py-6 glass border-b border-gray-200">
            ...
            <AnimatePresence mode="popLayout">
              {filteredProjects.map((project, index) => (
                ...
                >
                  ...
                  {/* Category Badge */}
                  <div className="absolute top-4 right-4 px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-xs font-semibold text-secondary">
                    {project.category}
                  </div>
                </motion.div>
              ))}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white/80">
              Companies that believe in our vision
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {clients.map((client, index) => (
              <motion.div
                ...
                className="glass-dark p-12 rounded-3xl text-center group cursor-pointer"
              >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
              Ready to see your project featured here? Let's make it happen.
            </p>
            <Link
              to="/contact"
